...
HD_PWD='D:/Projects_Git/DMA_UART/DMA_UART_2CH/DMA_UART_2CH.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log DMA_UART.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source DMA_UART.tcl

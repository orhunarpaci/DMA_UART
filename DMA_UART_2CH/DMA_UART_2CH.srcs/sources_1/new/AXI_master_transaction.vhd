...
architecture Behavioral of AXI_master is
    ...
    component FIFO
        ...
        port (
            ...
            o_data_cnt : out std_logic_vector(g_depth - 1 downto 0);
            o_ack      : out std_logic;
    ...
    if data_width = 32 generate
        ...
        read_data_fifo_inst : FIFO
            ...
            port map(
                i_clk      => m_axi_aclk,
                i_rst      => reset_fifos,
                i_wr_en    => read_data_fifo_wen,
                i_data_in  => read_data_fifo_input,
                i_rd_en    => read_data_fifo_en,
                o_data_out => read_data_fifo_output,
        ...
        write_data_fifo_inst : FIFO
            ...
            port map(
                i_clk      => m_axi_aclk,
                i_rst      => reset_fifos,
                i_wr_en    => write_data_fifo_wen,
                i_data_in  => write_data_fifo_input,
                i_rd_en    => write_data_fifo_en,
                o_data_out => write_data_fifo_output,
